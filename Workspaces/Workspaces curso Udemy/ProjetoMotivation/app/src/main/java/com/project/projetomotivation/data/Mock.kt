...
class Mock {
    ...
    private val all = MotivationConstraints.PHRASEFILTER.ALL
    private val happy = MotivationConstraints.PHRASEFILTER.HAPPY
    private val sunny = MotivationConstraints.PHRASEFILTER.SUNNY
    private val langEn = MotivationConstraints.LANGUAGE.ENGLISH
    private val langPt = MotivationConstraints.LANGUAGE.PORTUGUESE
    private val langFr = MotivationConstraints.LANGUAGE.FRENCH
